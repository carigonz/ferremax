...
@section('title', 'Actualizar Sección')
...
<section class="main-container-update flex-column container-fluid d-flex justify-content-around align-items-center">
    <h4><a href="{{route('configuration')}}">Configuración</a> / <strong>Editar sección</strong></h4>
    ...
    <div class="card" id="card">
        <div class="card-body container form-std">
            <div class="col-12 flex-column">
                {!! Form::open(array( 'route' => array('sections.update', $section->id), 'method' => 'put', 'class' => 'd-flex flex-column')) !!}
                <h5 class="card-title">Actualizar</h5>
                {!! Form::label('name', 'Nombre') !!}
                {!! Form::text('name', $section->name , array('placeholder' => 'Indica el nombre de la nuevo sección') ) !!}
                {!! Form::label('description', 'Descripción') !!}
                {!! Form::text('description', $section->description, array('placeholder' => 'Indica anotaciones o descripción') ) !!}
                {!! Form::label('category_id', 'Categoría') !!}
                {!! Form::select("category_id", $categories->pluck('name', 'id'), $section->category_id)!!}
