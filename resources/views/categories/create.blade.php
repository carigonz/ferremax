...
<section class="main-container-update flex-column container-fluid d-flex justify-content-around align-items-center">
    <h4><a href="{{route('configuration')}}">Configuración</a> / <strong>Nueva clasificación</strong></h4>
    ...
    <div class="card" id="card">
        <div class="card-body container form-std">
            <div class="col-12 flex-column">
                {!! Form::open(array('route' => 'categories.store', 'class'=>'d-flex flex-column')) !!}
                <h5 class="card-title">Crear</h5>
                {!! Form::label('name', 'Nombre') !!}
                {!! Form::text('name', null, array('placeholder' => 'Indica el nombre de la nueva categoría') ) !!}
                ...
                {!! Form::select("classification_id", $classifications->pluck('type', 'id'), null)!!}
